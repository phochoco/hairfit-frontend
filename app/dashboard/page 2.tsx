...
const fixResultOrientation = (
  ...
  return new Promise((resolve) => {
    ...
    // 캐시 우회용 파라미터 추가(같은 URL 여러 번 로딩 시)
    const urlWithBust =
  ...
  try {
    ...
    console.log("[handleGenerate] mask dataURL length:", maskData.length);
