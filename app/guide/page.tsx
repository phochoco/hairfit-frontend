      ...
      <div className="mx-auto max-w-3xl px-4 pb-12 pt-8 md:px-6 md:pt-10">
        ...
        <div className="space-y-6 md:space-y-7 text-sm md:text-base text-slate-800">
          ...
          <section className="rounded-2xl bg-white px-5 py-6 shadow-sm border border-slate-100">
            ...
            {/* 이용약관 */}
            <div id="terms-section" className="mt-4 space-y-4 text-sm md:text-base leading-relaxed">
              ...
              <p>
                ...
                &quot;서비스&quot;)의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임
                사항을 규정함을 목적으로 합니다.
              </p>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      &quot;서비스&quot;란 회사가 운영하는 웹사이트(https://re-fac.art) 및 관련
                      웹 애플리케이션을 통해 제공하는 AI 기반 얼굴 변환, 이미지 편집·생성 등
                      디지털 콘텐츠 서비스를 말합니다.
                    </li>
                    <li>
                    ...
                    <li>
                      &quot;디지털 콘텐츠&quot;란 서비스 이용을 통해 생성·제공되는 이미지, 파일, 기타 무형의
                      콘텐츠를 말합니다.
                    </li>
                    <li>
                      &quot;크레딧&quot;이란 서비스 내 유료 기능을 이용하기 위해 회사가 정한 기준에 따라
                      부여되는 결제 단위를 말합니다.
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <li>
                      회사는 관련 법령을 위배하지 않는 범위에서 약관을 개정할 수 있으며, 개정 시 시행일 및 개정 사유를 명시하여 적용일 7일 전부터 공지합니다. 이용자에게 불리한 변경의 경우 최소 30일 전에 공지합니다.
                    </li>
                    <li>
                      이용자가 개정 약관 시행일까지 명시적으로 거부 의사를 표시하지 않고 서비스를 계속 이용하는 경우, 변경된 약관에 동의한 것으로 봅니다.
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <li>
                      회사는 운영상·기술상의 필요에 따라 서비스의 내용을 변경할 수 있으며, 중요한 변경의 경우 사전에 공지합니다.
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      이용자는 회사가 정한 가입 양식에 따라 필요한 정보를 입력함으로써 회원가입을 신청할 수 있습니다.
                    </li>
                    <li>
                      회사는 회원가입 신청에 대해 원칙적으로 승낙하나, 다음 각 호에 해당하는 경우 승낙을 거절하거나 사후에 이용을 제한할 수 있습니다.
                      <ol className="list-decimal pl-5 mt-1 space-y-1">
                    ...
                    <li>
                      회원은 자신의 계정 정보가 도난·유출되지 않도록 관리할 책임이 있으며, 제3자에게 양도하거나 대여할 수 없습니다.
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      ...
                      <ol className="list-decimal pl-5 mt-1 space-y-1">
                        <li>타인의 얼굴·초상·개인정보를 무단으로 업로드하거나 사용하는 행위</li>
                        <li>타인의 저작권 등 지식재산권을 침해하는 행위</li>
                        <li>법령에 위반되거나 공공질서 및 미풍양속에 반하는 콘텐츠 생성·이용 행위</li>
                        <li>서비스의 정상적인 운영을 방해하는 모든 행위</li>
                      </ol>
                    </li>
                    <li>
                      이용자의 위법 또는 약관 위반으로 인해 발생한 손해에 대해서는 해당 이용자가 책임을 부담합니다.
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      이용자가 서비스에 업로드하는 원본 이미지는 해당 이용자의 책임과 권리 하에 있으며, 회사는 서비스 제공 목적 범위 내에서만 이를 처리·저장합니다.
                    </li>
                    <li>
                      서비스를 통해 생성된 결과물(이미지 등 디지털 콘텐츠)의 저작권 및 이용 권리는 관련 법령과 개별 안내에 따르며, 상업적 이용 가능 여부는 회사가 별도로 안내한 정책에 따릅니다.
                    </li>
                    <li>
                      회사는 서비스 품질 향상, 기능 개선, 통계 및 분석 등을 위해 비식별화된 형태로 데이터를 활용할 수 있습니다.
                    </li>
                  </ol>
                </div>

                <div>
                  <h4 className="font-semibold">제7조 (서비스 이용요금 및 결제)</h4>
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      서비스의 일부 또는 전부는 유료로 제공될 수 있으며, 구체적인 요금, 결제 방법, 환불 규정 등은 서비스 내 결제 페이지에 별도로 게시합니다.
                    </li>
                    <li>
                      이용자는 회사가 정한 방법(신용·체크카드, 간편결제 등)을 통하여 이용요금을 결제할 수 있습니다.
                    </li>
                    <li>
                      크레딧은 현금으로 환불하거나 제3자에게 양도할 수 없으며, 이용기간 및 소멸 조건은 별도의 정책에 따릅니다.
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      디지털 콘텐츠 특성상, 결제 후 서비스 제공(이미지 생성 시작 또는 크레딧 사용)이 이루어진 경우에는 「전자상거래법」 등 관련 법령에 따라 청약철회가 제한될 수 있습니다.
                    </li>
                    <li>
                      상세 환불 정책은 별도의{" "}
                      <a
                      ...
                      부분에 게시하며, 이용자는 결제 전에 반드시 확인해야 합니다.
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      회사는 천재지변, 정전, 서비스 설비 장애, 트래픽 폭주, 외부 서비스 연계 장애 등 불가피한 사유가 발생한 경우 서비스 제공을 일시 중단할 수 있습니다.
                    </li>
                    <li>
                      이 경우 회사는 사후에라도 서비스 내 공지 또는 이메일 등을 통해 이용자에게 알리기 위해 노력합니다.
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      회사는 관련 법령에서 허용되는 범위 내에서 서비스 이용과 관련하여 발생한 간접·우발·특별·결과적 손해에 대하여 책임을 지지 않습니다.
                    </li>
                    <li>
                      이용자의 귀책사유로 인한 서비스 장애 또는 손해에 대하여 회사는 책임을 지지 않습니다.
                    </li>
                  </ol>
                </div>

                <div>
                  <h4 className="font-semibold">제11조 (분쟁 해결 및 관할법원)</h4>
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      회사와 이용자 간에 발생한 분쟁은 상호 성실한 협의를 통해 해결하도록 노력합니다.
                    </li>
                    <li>
                      협의로 해결되지 않는 분쟁에 대해서는 회사의 본점 소재지를 관할하는 법원을 제1심 전속 관할법원으로 합니다.
                    </li>
                  </ol>
                </div>
            ...
            {/* 개인정보처리방침 */}
            <div id="privacy-section" className="mt-8 space-y-4 text-sm md:text-base leading-relaxed">
              <h3 className="text-base md:text-lg font-semibold mb-2">
                5-2. 개인정보처리방침
              </h3>

              <p>
                필름드림(이하 &quot;회사&quot;)는 Re-Fac Art 서비스(https://re-fac.art)를 이용하는
                이용자의 개인정보를 중요하게 생각하며, 「개인정보 보호법」 등 관련 법령을 준수합니다.
                회사는 본 개인정보처리방침을 통해 어떤 정보를 어떠한 목적으로 이용하는지, 이용자의 권리를
                어떻게 보장하는지 알려드립니다.
              </p>

              <div className="space-y-3">
                <div>
                  <h4 className="font-semibold">제1조 (수집하는 개인정보 항목)</h4>
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      회원가입 및 서비스 이용 시
                      <ol className="list-decimal pl-5 mt-1 space-y-1">
                    ...
                    <li>
                      결제 및 환불 처리 시
                      <ol className="list-decimal pl-5 mt-1 space-y-1">
                        <li>PG사(토스페이먼츠 등)를 통해 전달되는 결제 승인/취소 정보</li>
                        <li>신용·체크카드 정보, 계좌 정보 등은 PG사가 직접 처리하며, 회사는 원본 정보를 보관하지 않습니다.</li>
                      </ol>
                    </li>
                    <li>
                ...
                <div>
                  <h4 className="font-semibold">제2조 (개인정보의 수집·이용 목적)</h4>
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>회원 관리 및 본인확인</li>
                ...
                <div>
                  <h4 className="font-semibold">제3조 (개인정보의 보유 및 이용 기간)</h4>
                  <ol className="list-decimal pl-5 space-y-1">
                ...
                <div>
                  <h4 className="font-semibold">제4조 (개인정보의 제3자 제공)</h4>
                  <p>
                ...
                <div>
                  <h4 className="font-semibold">제5조 (개인정보 처리의 위탁)</h4>
                  <p>
                ...
                <div>
                  <h4 className="font-semibold">제6조 (이용자 및 법정대리인의 권리와 행사 방법)</h4>
                  <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <li>
                      ...
                      <span className="text-sky-600">myfilmdrim@gmail.com</span>)을 통해 요청할 수 있습니다.
                    </li>
                  </ol>
                </div>

                <div>
                  <h4 className="font-semibold">제7조 (개인정보의 파기 절차 및 방법)</h4>
                  <ol className="list-decimal pl-5 space-y-1">
                ...
                <div>
                  <h4 className="font-semibold">제9조 (개인정보 보호를 위한 기술적·관리적 대책)</h4>
                  <ol className="list-decimal pl-5 space-y-1">
                ...
                <div>
                  <h4 className="font-semibold">제10조 (개인정보 보호책임자)</h4>
                  <p>회사는 개인정보 보호 관련 업무를 총괄하는 개인정보 보호책임자를 지정하고 있습니다.</p>
                  <ul className="list-disc pl-5 mt-1 space-y-1">
                    <li>성명: 윤예준</li>
            ...
            {/* 환불정책 */}
            <div id="refund-section" className="mt-8 space-y-4 text-sm md:text-base leading-relaxed">
              <h3 className="text-base md:text-lg font-semibold mb-2">
                5-3. 환불정책
              </h3>

              <p>
                본 환불정책은 필름드림이 제공하는 Re-Fac Art(이하 &quot;서비스&quot;)의 유료 결제 및 디지털
                콘텐츠 이용과 관련된 환불 기준을 규정합니다.
              </p>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p>
                    본 정책은 서비스 내에서 결제한 크레딧, 이용권, 패키지 등 디지털 콘텐츠 및 유료 기능 이용에
                    적용됩니다.
                  </p>
                </div>

                <div>
                  <h4 className="font-semibold">제2조 (디지털 콘텐츠의 특성)</h4>
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      서비스는 AI를 활용하여 이용자가 업로드한 이미지를 기반으로 얼굴 변환 및 이미지 생성·편집을 제공하는 디지털 콘텐츠 서비스입니다.
                    </li>
                    <li>
                      디지털 콘텐츠의 특성상, 한 번 생성된 결과물은 회수·삭제가 가능하더라도 이미 열람 또는 다운로드가 이루어진 경우 재사용 방지가 어려울 수 있습니다.
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      「전자상거래 등에서의 소비자 보호에 관한 법률」 제17조 및 같은 법 시행령 제21조에 따라, 디지털 콘텐츠를 제공받은 경우에는 청약철회가 제한될 수 있습니다.
                    </li>
                    <li>
                      이용자가 결제 후 다음 각 호에 해당하는 경우, 사용된 부분에 대해서는 환불이 제한됩니다.
                      <ol className="list-decimal pl-5 mt-1 space-y-1">
                ...
                <div>
                  <h4 className="font-semibold">제4조 (결제 후 미사용 분에 대한 환불)</h4>
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      결제 후 어떠한 이미지 생성·편집도 진행하지 않은 상태(크레딧 미사용)에서 7일 이내 환불을 요청하는 경우, 결제 수수료 및 PG사 수수료를 제외한 금액을 환불할 수 있습니다.
                    </li>
                    <li>
                      부분 사용이 이미 이루어진 경우, 사용된 크레딧에 상응하는 금액은 환불 대상에서 제외됩니다.
                    </li>
                    <li>
                      이벤트·프로모션 등으로 무상 지급된 크레딧은 환불 대상에 포함되지 않습니다.
                    </li>
                  </ol>
                </div>

                <div>
                  <h4 className="font-semibold">제5조 (서비스 장애에 따른 환불·보상)</h4>
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      회사의 귀책 사유로 인해 결제 후 일정 기간 동안 서비스 이용이 불가능한 경우, 회사는 장애 시간 및 사용 이력 등을 고려하여 크레딧 복구 또는 추가 제공 등의 방식으로 보상할 수 있습니다.
                    </li>
                    <li>
                      천재지변, 통신사 장애, 외부 서비스(클라우드, PG사 등) 문제로 인한 서비스 중단의 경우, 관련 법령에서 정한 범위 내에서 책임을 집니다.
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      ...
                      <span className="text-sky-600">myfilmdrim@gmail.com</span>)을 통해 제출해야 합니다.
                      <ol className="list-decimal pl-5 mt-1 space-y-1">
                    ...
                    <li>
                      회사는 환불 요청을 접수한 날로부터 7영업일 이내에 검토하고, 승인 시 PG사 절차에 따라 환불을 진행합니다.
                    </li>
                    <li>
                      환불 처리에 소요되는 기간은 결제 수단 및 PG사 정책 등에 따라 다를 수 있습니다.
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-5 space-y-1">
                    <li>
                      본 환불정책에 명시되지 않은 사항은 관련 법령 및 서비스 이용약관에 따릅니다.
                    </li>
                    <li>
                      회사는 서비스 운영 정책 및 관련 법령 변경에 따라 본 환불정책을 개정할 수 있으며, 변경 시 서비스 내 공지를 통해 사전에 안내합니다.
                    </li>
                  </ol>
                </div>
