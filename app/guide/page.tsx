        ...
        <header className="mb-8 flex flex-col gap-4 md:mb-10 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-3 text-sm md:text-base text-slate-700 leading-relaxed">
              HairFit은 <b>머리는 그대로 두고, 얼굴만 AI로 자연스럽게 바꿔주는 서비스</b>입니다.
              <br className="hidden md:block" />
              고객 얼굴을 직접 쓰지 않아서, <b>초상권 부담을 줄이고</b> 안심하고 홍보하실 수 있어요.
            </p>
          </div>
        ...
        <div className="space-y-6 md:space-y-7 text-sm md:text-base text-slate-800">
          ...
          <section className="rounded-2xl bg-white px-5 py-5 shadow-sm border border-slate-100">
            ...
            <ul className="space-y-2 leading-relaxed">
              <li>• <b>머리는 그대로</b> 두고, 얼굴만 AI로 자연스럽게 바꿔줍니다.</li>
              <li>• 고객의 실제 얼굴을 그대로 쓰지 않아, <b>초상권 부담을 줄일 수 있습니다.</b></li>
              <li>• 상담 사진, 인스타·블로그 홍보 이미지에 쓰기 좋습니다.</li>
            </ul>
          </section>
          ...
          <section className="rounded-2xl bg-white px-5 py-5 shadow-sm border border-slate-100">
            ...
            <ol className="space-y-3 leading-relaxed list-decimal pl-5">
              <li>
                <span className="font-semibold">고객 사진 올리기</span> <span>📷</span>
                <p className="mt-1 text-slate-700">
                  정면, 옆모습 모두 괜찮습니다. <b>얼굴이 선명하게만 보이면 됩니다.</b>
                </p>
              </li>
              <li>
                <span className="font-semibold">눈·코·입만 쓱쓱 칠하기</span> <span>🎨</span>
                <p className="mt-1 text-slate-700">
                  얼굴 전체를 칠할 필요 없이, <b>눈·코·입만 마스킹</b>하면
                  가장 자연스럽게 바뀝니다.
                </p>
              </li>
              <li>
                <span className="font-semibold">AI 스타일 변환하기</span> <span>✨</span>
                <p className="mt-1 text-slate-700">
          ...
          <section className="rounded-2xl bg-white px-5 py-5 shadow-sm border border-slate-100">
            ...
            <p className="mt-3 text-xs md:text-sm text-slate-600 leading-relaxed">
              어떤 플랜이 좋을지 모르시겠다면, <b>Free로 먼저 써보신 뒤</b>  
              사용량에 따라 Starter → Pro 순으로 올려보시는 것을 추천드립니다.
            </p>
          </section>
          ...
          <section className="rounded-2xl bg-white px-5 py-5 shadow-sm border border-slate-100">
            ...
            <ul className="space-y-2 leading-relaxed">
              <li>📱 인스타그램, 카카오채널, 블로그용 스타일 사진 만들기</li>
              <li>🗣️ 시술 전, 고객에게 스타일 미리 보여주기</li>
              <li>🪞 매장 대표 스타일 사진 모아서 홍보 이미지 만들기</li>
            </ul>
          </section>
